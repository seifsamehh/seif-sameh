...
const HomeAr = () => {
  return (
    <>
      <Helmet>
        <title>سيف سامح</title>
      </Helmet>
      <HeaderAr />
      {/* start home */}
      <section className="home-ar">
        ...
        <div className="right-part">
          <motion.img
            ...
            alt="my avatar"
            drag
            dragConstraints={{ right: 0, left: -100, top: -100, bottom: 10 }}
          />
        </div>
      </section>
      {/* end home */}
      {/* start about heading */}
      <section className="about-heading-ar">
        ...
        <div className="container">
          ...
          <Parallax translateY={["-200px", "200px"]}>
            <div className="about-content">
              <h1>من أنا &#x1F60A;؟</h1>
              <p>
                أهلاً! اسمي سيف الدين سامح. أنا مطور ويب. شغفي هو إنشاء مواقع
                ويب إبداعية تستجيب بشكل كامل لجميع الأجهزة. أعمل على تحقيق أعلى
                مستوى من التفاعل والإبداع مع المستخدمين
              </p>
            </div>
          </Parallax>
        </div>
      ...
      <section className="skills-heading-ar">
        <Parallax translateY={["-200px", "200px"]}>
          <h1>مهارات</h1>
        </Parallax>
      </section>
      ...
      {/* end skills */}
      {/* start work heading */}
      <section className="projects-heading-ar">
        <Parallax translateY={["-200px", "200px"]}>
          <h1>أعمالى</h1>
        </Parallax>
      </section>
      ...
      <section className="snippet-heading-ar">
        <Parallax translateY={["-200px", "200px"]}>
          <h1>مقتطفات</h1>
        </Parallax>
      </section>
      ...
      <section className="contact-heading-ar">
        <Parallax translateY={["-200px", "200px"]}>
          <h1>للتواصل معى</h1>
        </Parallax>
      </section>
